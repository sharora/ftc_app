    ...
    public void runOpMode(){
        ...
        while(opModeIsActive()){
            ...
            if(gamepad1.left_bumper){
                robot.outake.setUpSlidePosition(-1460,1);

                if(robot.outake.upSlidePosition()<-500){

                    robot.outake.setDumpPos(robot.outake.getDumperPos() + 0.065*(Math.max(0.95-robot.outake.getDumperPos(),0.1)));
                }
