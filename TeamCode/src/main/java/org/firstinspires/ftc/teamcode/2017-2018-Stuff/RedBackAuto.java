...
//        encoderturn(-300, -0.15);
//        //prev value: 1290 ticks for unhang
        driveForward(1290, 0.5);
        turn(90, 0.2);
        ...
        if (opModeIsActive()) {
            ...
            driveForward(2400, 0.7);
            encoderturn(1000,0.3);
            driveForward(3500, 0.7);
            encoderturn(600,0.4);
